...
We welcome all contributions to SolvationFE!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/ljwoods2/solvationfe/issues)
...
The second two options both involve making a [pull request](https://github.com/ljwoods2/solvationfe/pulls) .
